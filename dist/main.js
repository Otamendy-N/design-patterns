...
function main() {
    ...
    let nikiesPackage = nikesFactory.createShoesPackage(200000);
    let addidasPackage = addidasFactory.createShoesPackage(200000);
...
console.log("[SYSTEM INFO] Total excecution of this program took: " + totalTime + " ms.");
